...
const statusConfig: Record<StatusType, { style: string; Icon: LucideIcon }> = {
  active: {
    style: 'bg-green-500/15 text-green-600 hover:bg-green-500/25 border-green-500/20',
    Icon: CheckCircle2,
  },
  pending: {
    style: 'bg-yellow-500/15 text-yellow-600 hover:bg-yellow-500/25 border-yellow-500/20',
    Icon: Clock,
  },
  error: {
  ...
  closed: {
    style: 'bg-gray-500/15 text-gray-600 hover:bg-gray-500/25 border-gray-500/20',
    Icon: XCircle,
  },
  expired: {
    style: 'bg-orange-500/15 text-orange-600 hover:bg-orange-500/25 border-orange-500/20',
    Icon: Timer,
  },
  processing: {
    style: 'bg-blue-500/15 text-blue-600 hover:bg-blue-500/25 border-blue-500/20',
    Icon: Loader2,
  },
  completed: {
    style: 'bg-emerald-500/15 text-emerald-600 hover:bg-emerald-500/25 border-emerald-500/20',
    Icon: CheckCircle,
  },
  rejected: {
    style: 'bg-red-500/15 text-red-600 hover:bg-red-500/25 border-red-500/20',
