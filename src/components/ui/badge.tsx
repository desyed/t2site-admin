...
const badgeVariants = cva(
	"py-0.2 inline-flex items-center !rounded-lg px-2 text-[10px] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
	{
		variants: {
			variant: {
				default:
