...
const ChatWidgetPreview = ({ logoPreviewUrl }: ChatWidgetPreviewProps) => {
  return (
    <div className="h-[600px] w-[400px] rounded-xl outline outline-1 outline-gray-200">
      <Slider {...sliderSettings} className="h-full">
        {/* Conversation Screen */}
        <div className="h-[600px] overflow-hidden rounded-xl bg-gradient-to-b from-[var(--chat-bg)] to-[#F5F5F5]">
          {/* Chat Header */}
