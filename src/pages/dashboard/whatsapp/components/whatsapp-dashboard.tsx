...
export function WhatsappDashboard({ projectId }: WhatsappDashboardProps) {
  ...
  const chatMessages = [
    ...
    },
    {
      ...
      sender: 'business',
      message:
        'Perfect! Our premium package includes advanced analytics dashboard, support for WhatsApp, Facebook, Instagram, and Email, plus priority customer support.',
      time: '2:37 PM',
      status: 'read',
    },
    {
          ...
          {whatsappAccounts.map((account) => (
            <Card key={account.id}>
              <CardContent className="p-4">
                ...
                <p className="mb-2 text-sm text-gray-600">{account.phone}</p>
