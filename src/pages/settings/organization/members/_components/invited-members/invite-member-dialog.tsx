          ...
          <DialogContent className="p-0 sm:max-w-[756px]">
            <DialogHeader className="px-5 pt-5">
              ...
              <DialogDescription className="pb-1 text-base">
                Invite others to your organization to collaborate together. An invite is specific to
                an email address and expires after 3 days. Name can be provided for the team{' '}
